    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: focusBorder ?? OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(width: 2, color: UiColor.blueColor)),
